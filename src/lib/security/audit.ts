...
export const AUDIT_EVENT_TYPES = {
  ...
  messagingConversationAssigned: "messaging.conversation.assigned",
  messagingConversationReassigned: "messaging.conversation.reassigned",
  messagingConversationUnassigned: "messaging.conversation.unassigned",
  ...
  listingLiveEditSubmissionStaged: "provider.listing_live_edit_submission.staged",
  listingLiveEditSubmissionSent: "provider.listing_live_edit_submission.sent",
  listingLiveEditApproved: "provider.listing_live_edit.approved",
  listingLiveEditNeedsChanges: "provider.listing_live_edit.needs_changes",
  listingLiveEditRejected: "provider.listing_live_edit.rejected",
