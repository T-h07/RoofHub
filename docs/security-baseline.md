...
- Resolve active company context from persisted profile selection or an unambiguous single active membership only; company-context reads must not mutate `profiles.active_organization_id`.
